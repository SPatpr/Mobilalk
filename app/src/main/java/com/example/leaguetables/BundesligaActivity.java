...
public class BundesligaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("standings").document("bundesliga")
        ...
        bottomNav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_top5) {
                    ...
                    startActivity(new Intent(BundesligaActivity.this, ProfileActivity.class));
                    return true;
                }
                return false;
            }
        ...
        builder.setTitle("Top 5 bajnokságok")
                .setItems(leagues, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(BundesligaActivity.this, "Kiválasztva: " + selected, Toast.LENGTH_SHORT).show();
                        switch (selected) {
                            case "Premier League":
                                startActivity(new Intent(BundesligaActivity.this, PlActivity.class));
                                break;
                            case "La Liga":
                                startActivity(new Intent(BundesligaActivity.this, LaligaActivity.class));
                                break;
                            case "Bundesliga":
                                startActivity(new Intent(BundesligaActivity.this, BundesligaActivity.class));
                                break;
                            case "Serie A":
                                startActivity(new Intent(BundesligaActivity.this, SeriaActivity.class));
                                break;
                            case "Ligue 1":
                                startActivity(new Intent(BundesligaActivity.this, Ligue1Activity.class));
                                break;
                            default:
                                break;
                        }
