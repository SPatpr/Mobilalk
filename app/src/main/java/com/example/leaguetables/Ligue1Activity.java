...
public class Ligue1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("standings").document("ligue1")
        ...
        bottomNav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_top5) {
                    ...
                    startActivity(new Intent(Ligue1Activity.this, ProfileActivity.class));
                    return true;
                }
                return false;
            }
        ...
        builder.setTitle("Top 5 bajnokságok")
                .setItems(leagues, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(Ligue1Activity.this, "Kiválasztva: " + selected, Toast.LENGTH_SHORT).show();
                        switch (selected) {
                            case "Premier League":
                                startActivity(new Intent(Ligue1Activity.this, PlActivity.class));
                                break;
                            case "La Liga":
                                startActivity(new Intent(Ligue1Activity.this, LaligaActivity.class));
                                break;
                            case "Bundesliga":
                                startActivity(new Intent(Ligue1Activity.this, BundesligaActivity.class));
                                break;
                            case "Serie A":
                                startActivity(new Intent(Ligue1Activity.this, SeriaActivity.class));
                                break;
                            case "Ligue 1":
                                startActivity(new Intent(Ligue1Activity.this, Ligue1Activity.class));
                                break;
                            default:
                                break;
                        }
